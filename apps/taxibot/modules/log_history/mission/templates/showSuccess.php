...
<div id="content">	
	...
	<div id="time_interval_table_container" style="float:left;margin-right: 20px">
		<table class="time_interval" id="time_interval_table" border="1" style="height: 40px">
			<tbody>
				<tr>
					<th><?php echo date("Y-m-d", $to_str);?> </th>
	...
	<div id="taxibot_number_table_container">
		<table  id="taxibot_number_table" border="1" style="float:left; margin-right: 20px; height: 40px">
			<tbody>
				<tr>
					<th>Taxibot number</th>
				</tr>
				<tr>
					<th>  <?php echo $tractorId;?> </th>
				</tr>		
			</tbody>
		</table>
	</div>
	...
	<div id="blf_number_table_container">
		<table  id="blf_number_table" border="1" style="height: 40px">
			<tbody>
				<tr>
					<th>BLF(Archive) filename</th>
				</tr>
				<tr>
					<th>  20140305_HIL_M7_L0_M1_L0_M2_L0 </th>
				</tr>		
			</tbody>
		</table>
	</div>
	
	<div id="operating_hours_table_container" style="float: left ;margin-right: 5px">
			<h1><?php echo "Mission Operating Hours"  ?></h1>
	...
	<div id="rtc_hours_table_container" style="float: left ;margin-right: 5px">
		
		<table class="data" id="rtc_hours_table" style="margin-top: 31px" border="1">
			<body>
				<tr >
					<th  style="height: 30px; width: 50px; background-color: #777777;color: #FFFFFF " >RTC</th>
				</tr>
	...
	<div id="driver_time_stamp_table_container" style="float: left; margin-left: 35px;margin-right: 35px">
			<h1><?php echo "Driver Time Stamp"  ?></h1>
			<table class="data" id="driver_time_stamp" border="1" >
				<tbody>
					<tr >
						<th colspan="2" style="height: 30px; background-color: #777777;color: #FFFFFF " >RTC</th>
					</tr>
					<tr>
	...
	<div id="fuel_consumption_table_container" style="margin-left: 35px;margin-right: 50px">
			<h1><?php echo "Mission Fuel Consumption"  ?></h1>
