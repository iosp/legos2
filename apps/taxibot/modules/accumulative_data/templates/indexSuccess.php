...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="<?php echo url_for('accumulative_data/show?id='.$TaxibotMission->getId()) ?>"><?php echo $TaxibotMission->getId() ?></a></td>
  ...
  <a href="<?php echo url_for('accumulative_data/new') ?>">New</a>
