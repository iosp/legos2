...
/**
 * TaxibotVector filter form base class.
 *
 * @package    legos2
 * @subpackage filter
 * @author     Your name here
 */
abstract class BaseTaxibotVectorFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'aircraft_type_validity'                    => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'aircraft_weight'                           => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'aircraft_weight_validity'                  => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'aircraft_cg'                               => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'aircraft_cg_validity'                      => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      ...
      'nlg_lateral_force'                         => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'nlg_logitudal_force_tug'                   => new sfWidgetFormFilterInput(array('with_empty' => false)),
      ...
      'total_right_engine_hours'                  => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'total_left_engine_hours'                   => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'loading_step'                              => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'total_fuel_used_engine_right'              => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'total_fuel_used_engine_left'               => new sfWidgetFormFilterInput(),
    ));
    ...
    $this->setValidators(array(
      ...
      'aircraft_type_validity'                    => new sfValidatorPass(array('required' => false)),
      'aircraft_weight'                           => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'aircraft_weight_validity'                  => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'aircraft_cg'                               => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'aircraft_cg_validity'                      => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      ...
      'nlg_lateral_force'                         => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'nlg_logitudal_force_tug'                   => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      ...
      'total_right_engine_hours'                  => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'total_left_engine_hours'                   => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'loading_step'                              => new sfValidatorPass(array('required' => false)),
      'total_fuel_used_engine_right'              => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'total_fuel_used_engine_left'               => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
    ));

    $this->widgetSchema->setNameFormat('taxibot_vector_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'aircraft_type_validity'                    => 'Text',
      'aircraft_weight'                           => 'Number',
      'aircraft_weight_validity'                  => 'Boolean',
      'aircraft_cg'                               => 'Number',
      'aircraft_cg_validity'                      => 'Boolean',
      ...
      'nlg_lateral_force'                         => 'Number',
      'nlg_logitudal_force_tug'                   => 'Number',
      ...
      'total_right_engine_hours'                  => 'Number',
      'total_left_engine_hours'                   => 'Number',
      'loading_step'                              => 'Text',
      'total_fuel_used_engine_right'              => 'Number',
      'total_fuel_used_engine_left'               => 'Number',
    );
  }
}
