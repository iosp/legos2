...
/**
 * TaxibotVector form base class.
 *
 * @method TaxibotVector getObject() Returns the current form's model object
 *
 * @package    legos2
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseTaxibotVectorForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'aircraft_type_validity'                    => new sfWidgetFormInputText(),
      'aircraft_weight'                           => new sfWidgetFormInputText(),
      'aircraft_weight_validity'                  => new sfWidgetFormInputCheckbox(),
      'aircraft_cg'                               => new sfWidgetFormInputText(),
      'aircraft_cg_validity'                      => new sfWidgetFormInputCheckbox(),
      ...
      'nlg_lateral_force'                         => new sfWidgetFormInputText(),
      'nlg_logitudal_force_tug'                   => new sfWidgetFormInputText(),
      ...
      'total_right_engine_hours'                  => new sfWidgetFormInputText(),
      'total_left_engine_hours'                   => new sfWidgetFormInputText(),
      'loading_step'                              => new sfWidgetFormInputText(),
      'total_fuel_used_engine_right'              => new sfWidgetFormInputText(),
      'total_fuel_used_engine_left'               => new sfWidgetFormInputText(),
    ));
    ...
    $this->setValidators(array(
      ...
      'aircraft_type_validity'                    => new sfValidatorString(array('max_length' => 255)),
      'aircraft_weight'                           => new sfValidatorNumber(),
      'aircraft_weight_validity'                  => new sfValidatorBoolean(),
      'aircraft_cg'                               => new sfValidatorNumber(),
      'aircraft_cg_validity'                      => new sfValidatorBoolean(),
      ...
      'nlg_lateral_force'                         => new sfValidatorNumber(),
      'nlg_logitudal_force_tug'                   => new sfValidatorNumber(),
      ...
      'total_right_engine_hours'                  => new sfValidatorNumber(),
      'total_left_engine_hours'                   => new sfValidatorNumber(),
      'loading_step'                              => new sfValidatorString(array('max_length' => 255)),
      'total_fuel_used_engine_right'              => new sfValidatorNumber(),
      'total_fuel_used_engine_left'               => new sfValidatorNumber(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('taxibot_vector[%s]');
