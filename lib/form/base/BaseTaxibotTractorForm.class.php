...
abstract class BaseTaxibotTractorForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'pcm_hours'     => new sfWidgetFormInputText(),
      'dcm_hours'     => new sfWidgetFormInputText(),
    ));

    $this->setValidators(array(
      'id'            => new sfValidatorChoice(array('choices' => array($this->getObject()->getId()), 'empty_value' => $this->getObject()->getId(), 'required' => false)),
      'tractor_id'    => new sfValidatorInteger(array('min' => -2147483648, 'max' => 2147483647)),
      'name'          => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'creation_date' => new sfValidatorDateTime(array('required' => false)),
      'pcm_hours'     => new sfValidatorNumber(array('required' => false)),
      'dcm_hours'     => new sfValidatorNumber(array('required' => false)),
    ));
